...
# ubuntu-iso-builder-import-pacstall-budgie-theme-jasper
...
> [ubuntu-iso-builder-import-pacstall-budgie-theme-jasper](https://samwhelp.github.io/ubuntu-iso-builder-import-pacstall-budgie-theme-jasper/)
...
| Config |
| ------ |
| [~/.config](https://github.com/samwhelp/ubuntu-iso-builder-import-pacstall-budgie-theme-jasper/tree/main/profile/template/asset/overlay/etc/skel/.config) |
| [/usr/share/glib-2.0/schemas](https://github.com/samwhelp/ubuntu-iso-builder-import-pacstall-budgie-theme-jasper/tree/main/profile/template/asset/overlay/usr/share/glib-2.0/schemas) |
| [/etc/dconf/db/distro.d](https://github.com/samwhelp/ubuntu-iso-builder-import-pacstall-budgie-theme-jasper/tree/main/profile/template/asset/overlay/etc/dconf/db/distro.d) |
...
> clone [ubuntu-iso-builder-import-pacstall-budgie-theme-jasper](https://github.com/samwhelp/ubuntu-iso-builder-import-pacstall-budgie-theme-jasper)

``` sh
git clone https://github.com/samwhelp/ubuntu-iso-builder-import-pacstall-budgie-theme-jasper.git
```


> change dir to `ubuntu-iso-builder-import-pacstall-budgie-theme-jasper`

``` sh
cd ubuntu-iso-builder-import-pacstall-budgie-theme-jasper
```
...
> change dir to `~/work/ubuntu-iso-builder-import-pacstall-budgie-theme-jasper/iso-profile`

``` sh
cd ~/work/ubuntu-iso-builder-import-pacstall-budgie-theme-jasper/iso-profile
```
...
> The resulting ISO file will be placed on `~/work/ubuntu-iso-builder-import-pacstall-budgie-theme-jasper/iso-profile/dist`
...
| [Ubuntu / ISO Builder / Template / Budgie](https://samwhelp.github.io/ubuntu-iso-builder-template/read/respin/budgie.html) |  |
